...
const libsodium_version: &'static str = "1.0.11";
...
fn main() {
    ...
    if let Ok(lib_dir) = env::var("SODIUM_LIB_DIR") {
        ...
        if lib_details.version != libsodium_version {
...
fn main() {
    ...
    // Download gz tarball
    let basename = "libsodium-".to_string() + libsodium_version;
...
fn main() {
    ...
    let url = "https://github.com/jedisct1/libsodium/releases/download/".to_string() + libsodium_version +
              "/" + &gz_filename;
